...
function Doctoredit() {
    ...
    const profile=async()=>{
        try{
        const id=localStorage.getItem('doctorlogid')
        const response = await axios.get(`http://localhost:8000/api/doctor/doctorprofile/${id}`)
        console.log(response.data)
          setDoctorName(response.data.doctor.doctorName)
    setRegno(response.data.doctor.regno)
    setClinicName(response.data.doctor.clinicName)
    setClinicAddress(response.data.doctor.clinicAddress)
    setAvailibleDays(response.data.doctor.availibleDays)
   setConsultationTimeFrom(response.data.doctor.consultationTimeFrom)
   setConsultationTimeTo(response.data.doctor.consultationTimeTo)
    setFees(response.data.doctor.fees)
   ...
   settoken(response.data.doctor.tokens)
    ...
    const editDoctor = async (e) => {
        ...
        try {
            ...
            console.log(data)
            const response = await axios.put(`http://localhost:8000/api/doctor/editprofile/${id}`,data,
                {
                    headers: {
            ...
            <Container fluid className="d-flex justify-content-center align-items-center min-vh-100" 
                ...
                >
                    <Card.Body className="p-5">
                        ...
                        <Form noValidate onSubmit={editDoctor}>
                            <Row className="mb-3">
